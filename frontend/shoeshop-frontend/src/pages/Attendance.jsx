...
const AttendancePage = () => {
  ...
  const fetchAttendanceRecords = async () => {
    try {
      setLoading(true);
      const data = await attendanceService.getAllRecords();
  ...
  const handleSearch = async () => {
    ...
    try {
      setLoading(true);
      const data = await attendanceService.searchRecords(searchId);
      setAttendanceRecords(data.records || []);
    } catch (err) {
  ...
  const handleUpdateClick = async () => {
    ...
    try {
      setLoading(true);
      await attendanceService.updateRecord(selectedRecord._id, formData);
      setIsEditing(false);
