...
function EmployeeBonusTracker() {
  ...
  // Helper function to format the amount in LKR
            ...
            <div className="dashboard">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-4 rounded shadow-md">
                  ...
                  <p className="text-xl">{formatCurrency(employee.totalBonus)}</p>
                      ...
                      <div key={index} className="flex items-center p-4 bg-white rounded shadow-md">
                        ...
                        <div>
                          <p className="font-medium">
                            {item.hours ? `Overtime: ${item.hours} hours` : `Bonus: ${formatCurrency(item.amount)}`}
                          </p>
                          <p>{item.reason}</p>
                  ...
                  <tbody>
                    {bonuses.map((bonus) => (
                      <tr key={bonus.id} className="border-b">
                        ...
                        <td className="p-4">{formatCurrency(bonus.amount)}</td>
            ...
            <div className="add-bonus">
              ...
              <form onSubmit={handleAddBonus} className="space-y-4">
                <div className="flex flex-col">
                  <label className="font-medium">Bonus Amount (LKR)</label>
                  <input
                    type="number"
