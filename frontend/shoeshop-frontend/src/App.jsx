...
function App() {
  ...
  const noFooterRoutes = ['/customerlogin', '/login', '/customerregister', '/customerdashboard', '/employeelogin', '/admindashboard','/shoes', '/dashboard','/categories','/restock','/shoes/add','/shoes/:id/edit', '/HRdashboard', '/employee','/department','/leaves','/Salary','/attendance','/employeeDashboard','/applyleave','/salary&promotion','/AddNewEmployee','/trackingbonus','/EmAttendance','/SalesPerformance','/salary'];
  const noHeaderRoutes = ['/employeelogin', '/admindashboard', '/dashboard','/shoes','/dashboard','/categories','/restock','/shoes/add','/shoes/:id/edit', '/HRdashboard', '/employee','/department','/leaves','/Salary','/attendance','/employeeDashboard','/applyleave','/salary&promotion','/AddNewEmployee','/trackingbonus','/EmAttendance','/SalesPerformance','/salary'];
